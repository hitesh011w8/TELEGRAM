...
class Database:
    ...
    def _print_startup_message(self):
        ...
        print(f"\n{Fore.CYAN}{'='*50}")
        print(f"{Fore.CYAN}🚀 𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋 - Database Initialization")
    ...
    def _migrate_existing_users(self):
        ...
        try:
            update_result = self.users.update_many(
                ...
                {"$set": {"bot_username": "𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋"}}
            )
    ...
    def get_user(self, user_id: int, bot_username: str = "𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋") -> Optional[dict]:
        """
    ...
    def is_user_authorized(self, user_id: int, bot_username: str = "𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋") -> bool:
        """
    ...
    def remove_user(self, user_id: int, bot_username: str = "𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋") -> bool:
        """
    ...
    def list_users(self, bot_username: str = "𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋") -> List[dict]:
        """
    ...
    def list_bot_usernames(self) -> List[str]:
        ...
        try:
            ...
            return usernames if usernames else ["𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋"]
        except Exception as e:
            print(f"{Fore.RED}List bot usernames error: {str(e)}{Style.RESET_ALL}")
            return ["𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋"]
    ...
    def get_user_expiry_info(self, user_id: int, bot_username: str = "𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋") -> Optional[dict]:
        """
...
# 🔰 Startup Message
print(f"\n{Fore.CYAN}{'='*50}")
print(f"🤖 Initializing 𝐌 𝐈 𝐂 𝐇 𝐀 𝐄 𝐋 Bot Database")
print(f"{'='*50}{Style.RESET_ALL}\n")
